...
public interface AcademyAboutService {
     ...
     * @return 수정 결과
     */
    Response updateAcademyAbout(RequestAcademyAboutUpdate request);
     ...
     * @return 생성된 상세 정보 ID
     */
    ResponseData<Long> createDetails(RequestAcademyAboutDetailsCreate request);
     ...
     * @return 수정 결과
     */
    Response updateDetails(Long id, RequestAcademyAboutDetailsUpdate request);
     ...
     * @return 순서 변경 결과
     */
    Response updateDetailsOrder(RequestDetailsOrderUpdate request);
