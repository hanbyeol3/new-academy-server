...
public enum ErrorCode {
    ...
    AUTH_ACCOUNT_LOCKED(HttpStatus.LOCKED, "AUTH_ACCOUNT_LOCKED", "잠금된 계정입니다. 관리자에게 문의하세요."),
    ...
    // 설명회 관련 에러
    EXPLANATION_NOT_FOUND(HttpStatus.NOT_FOUND, "EXPLANATION_NOT_FOUND", "설명회를 찾을 수 없습니다."),
    EXPLANATION_SCHEDULE_NOT_FOUND(HttpStatus.NOT_FOUND, "EXPLANATION_SCHEDULE_NOT_FOUND", "설명회 회차를 찾을 수 없습니다."),
    EXPLANATION_SCHEDULE_NOT_RESERVABLE(HttpStatus.BAD_REQUEST, "EXPLANATION_SCHEDULE_NOT_RESERVABLE", "예약 가능하지 않은 회차입니다."),
    EXPLANATION_SCHEDULE_FULL(HttpStatus.CONFLICT, "EXPLANATION_SCHEDULE_FULL", "정원이 마감되었습니다."),
    EXPLANATION_SCHEDULE_OUT_OF_APPLY_PERIOD(HttpStatus.BAD_REQUEST, "EXPLANATION_SCHEDULE_OUT_OF_APPLY_PERIOD", "예약 신청 기간이 아닙니다."),
    EXPLANATION_RESERVATION_NOT_FOUND(HttpStatus.NOT_FOUND, "EXPLANATION_RESERVATION_NOT_FOUND", "예약을 찾을 수 없습니다."),
    EXPLANATION_RESERVATION_DUPLICATE(HttpStatus.CONFLICT, "EXPLANATION_RESERVATION_DUPLICATE", "이미 예약된 전화번호입니다."),
    EXPLANATION_RESERVATION_ALREADY_CANCELED(HttpStatus.BAD_REQUEST, "EXPLANATION_RESERVATION_ALREADY_CANCELED", "이미 취소된 예약입니다."),
    EXPLANATION_SCHEDULE_CAPACITY_VIOLATION(HttpStatus.BAD_REQUEST, "EXPLANATION_SCHEDULE_CAPACITY_VIOLATION", "현재 예약 인원보다 적은 정원으로 설정할 수 없습니다."),
    EXPLANATION_SCHEDULE_MISMATCH(HttpStatus.BAD_REQUEST, "EXPLANATION_SCHEDULE_MISMATCH", "설명회와 회차 정보가 일치하지 않습니다."),
    DUPLICATE_ROUND_NO(HttpStatus.CONFLICT, "DUPLICATE_ROUND_NO", "중복된 회차 번호입니다."),

    // 원서접수 관련 에러
    APPLY_APPLICATION_NOT_FOUND(HttpStatus.NOT_FOUND, "APPLY_APPLICATION_NOT_FOUND", "원서접수를 찾을 수 없습니다."),
    APPLY_APPLICATION_ALREADY_COMPLETED(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_ALREADY_COMPLETED", "이미 처리 완료된 원서접수입니다."),
    APPLY_APPLICATION_ALREADY_CANCELED(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_ALREADY_CANCELED", "이미 취소된 원서접수입니다."),
    APPLY_APPLICATION_CANNOT_DELETE(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_CANNOT_DELETE", "처리 완료되거나 취소된 원서접수는 삭제할 수 없습니다."),
    APPLY_APPLICATION_INVALID_STATUS(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_INVALID_STATUS", "유효하지 않은 상태입니다."),
    APPLY_APPLICATION_INVALID_DIVISION(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_INVALID_DIVISION", "유효하지 않은 구분입니다."),
    APPLY_APPLICATION_INVALID_SUBJECTS(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_INVALID_SUBJECTS", "선택한 구분에 맞지 않는 과목입니다."),
    APPLY_APPLICATION_DUPLICATE_PHONE(HttpStatus.CONFLICT, "APPLY_APPLICATION_DUPLICATE_PHONE", "같은 전화번호로 이미 접수된 원서가 있습니다."),
    APPLY_APPLICATION_LOG_NOT_FOUND(HttpStatus.NOT_FOUND, "APPLY_APPLICATION_LOG_NOT_FOUND", "원서접수 이력을 찾을 수 없습니다."),
    APPLY_APPLICATION_ASSIGNEE_NOT_FOUND(HttpStatus.NOT_FOUND, "APPLY_APPLICATION_ASSIGNEE_NOT_FOUND", "담당자를 찾을 수 없습니다."),
    APPLY_APPLICATION_STATUS_TRANSITION_INVALID(HttpStatus.BAD_REQUEST, "APPLY_APPLICATION_STATUS_TRANSITION_INVALID", "유효하지 않은 상태 변경입니다."),
    INVALID_APPLICATION_STATUS(HttpStatus.BAD_REQUEST, "INVALID_APPLICATION_STATUS", "유효하지 않은 상태입니다."),
    INVALID_SUBJECT_FOR_DIVISION(HttpStatus.BAD_REQUEST, "INVALID_SUBJECT_FOR_DIVISION", "선택한 구분에 맞지 않는 과목입니다."),
    SUBJECT_REQUIRED_FOR_DIVISION(HttpStatus.BAD_REQUEST, "SUBJECT_REQUIRED_FOR_DIVISION", "해당 구분에는 과목 선택이 필요합니다."),
    INVALID_SUBJECT_FOR_MIDDLE(HttpStatus.BAD_REQUEST, "INVALID_SUBJECT_FOR_MIDDLE", "중등부는 국어, 영어, 수학, 사회, 과학만 선택할 수 있습니다."),
    INVALID_SUBJECT_FOR_HIGH(HttpStatus.BAD_REQUEST, "INVALID_SUBJECT_FOR_HIGH", "고등부는 국어, 영어, 수학만 선택할 수 있습니다.");
