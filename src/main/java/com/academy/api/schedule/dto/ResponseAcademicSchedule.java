...
@Getter
@Builder
@Schema(description = "학사일정 응답")
public class ResponseAcademicSchedule {
     ...
     * Entity에서 DTO로 변환.
     */
    public static ResponseAcademicSchedule from(AcademicSchedule schedule) {
        return ResponseAcademicSchedule.builder()
                .id(schedule.getId())
     ...
     */
    public static ResponseAcademicSchedule fromWithNames(AcademicSchedule schedule, 
     ...
     */
    public static List<ResponseAcademicSchedule> fromList(List<AcademicSchedule> schedules) {
        return schedules.stream()
                .map(ResponseAcademicSchedule::from)
                .toList();
    }
}